...
The window composition follows assets/pika/reference/ui-reference.png at
...
to rcWork, allowing Pika's visible feet to sit directly above the taskbar even
...
All eleven strips load once from assets/pika/moods beside the executable.
...
tools/prepare-pika.cjs uses Node.js and Sharp. The original visual poses come
